package com.twg.springmvc.MydairyApplication.Controllers;
...
import com.twg.springmvc.MydairyApplication.business.EntryBusinessInterface;
import com.twg.springmvc.MydairyApplication.business.UserBusinessInterface;
	...
	public ModelAndView authenticateUser(@ModelAttribute("user") User user) {
	    ...
	    if (user1 != null && user.getPassword().equals(user1.getPassword())) {
	       ...
	       model.addObject("entrieslist",entries);
	        ...
	        // Optionally add an error message if authentication fails
